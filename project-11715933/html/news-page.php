...
<body>
    ...
    <div class="container-fluid nav">
        ...
        <nav class="navbar navbar-expand-md fixed-top">
            ...
            <ul class="collapse navbar-collapse navbar-nav mr-auto ml-auto align-content-md-between ">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#news" style="color:#ffc201; ">News</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        ...
        <!--first row news -->
        <div class="titlediv">Top News</div>
        <div class="row  mb-4">
            <div class="col-md-8 image">
                <a href="article-news.php">
                    <img src="../pic/news1.jpg" alt="" style="height: 100%; width: 100%">

                    <h2><span>Sterling overnight volatility jumps to highest since 2017 UK <span class='spacer'>general election</span><span class='spacer'></span></span></h2>
            ...
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-12">
                        <a href="article-news.php">
                            <img src="../pic/news2.jpg" alt="test" class="img-responsive" style="height: 100%; width: 100%">

                            <div class="carousel-caption">
                                <span class="text">Dollar falls as Fed officials ring note of caution, pound bounces</span>
                            </div>
                        </a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="article-news.php">
                            <img src="../pic/news3.jpg" alt="test" class="img-responsive" style="height: 100%; width: 100%">
        ...
        <div class="row mt-15">
            <div class="col-md-4">
                <a href="article-news.php">
                    <img src="../pic/crypto-news-4-600x450.jpg" alt="test" class="img-responsive" style="height: 100%; width: 100%">

                    <div class="carousel-caption">
                        <span class="text">Russians Bisiops Condems Cryptocurrecy</span>
                    </div>
                </a>
            </div>
            <div class="col-md-4">
                <a href="article-news.php">
                    <img src="../pic/crypto-news-5-600x450.jpg" alt="test" class="img-responsive" style="height: 100%; width: 100%">
            ...
            <div class="col-md-4">
                <a href="article-news.php">
                    <img src="../pic/crypto-news-2-600x450.jpg" alt="test" class="img-responsive" style="height: 100%; width: 100%">
        ...
        <!--row for latest news  -->
        <div class="titlediv">The newest News</div>
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card" style="">
                    <a href="article-news.php">
                        <img class="card-img-top" src="../pic/crypto-news-2-600x450.jpg" alt="img" style="width: 100% ;height: 231px">
                        <div class="card-body">
                            <p class="card-text"><span class="title">Lorem ipsum dolor sit amet,</span> <br> consectetur adipiscing elit. Donec sit amet ex placerat, blandit sapien in, egestas eros. Sed lobortis sollicitudin luctus. Pellentesque et iaculis metus. Suspendisse eget metus dignissim, convallis mauris vitae, lobortis lorem. Nunc viverra, dui ac lacinia varius, magna magna luctus ligula, et dapibus ssssssssss s s s s s s s s s s s s s s</p>
                        </div>
                    </a>
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="card" style="">
                    <a href="article-news.php">
                        ...
                        <div class="card-body">
                            <p class="card-text"><span class="title">Lorem ipsum dolor </span> <br>sit amet, consectetur adipiscing elit. Donec sit amet ex placerat, blandit sapien in, egestas eros. Sed lobortis sollicitudin luctus. Pellentesque et iaculis metus. Suspendisse eget metus dignissim, convallis mauris vitae, lobortis lorem. Nunc viverra, dui ac lacinia varius, magna magna luctus ligula, et dapibus ssssssssss s s s s </p>
                        </div>
                    </a>
                </div>
            </div>
