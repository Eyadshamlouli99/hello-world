...
<form action="editor.php" method="post">
    <div class="top">
        ...
        <input type="text" class="form-control input" name="topic" value="<?php echo $topicerr;?>">
    </div>
...
if (!$db->query($sql)) {
  ...
  //  $myfile = fopen("newfile" . $GLOBALS['n'] . ".txt", "w") or die("Unable to open file!");
  //  fwrite($myfile, $data);
    if(empty($topicerr)) {
