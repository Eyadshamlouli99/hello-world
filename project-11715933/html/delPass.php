    ...
    <div class="login-form col-lg-4 offset-lg-4">
        ...
        <form method="POST"action="<?php echo $_SERVER['PHP_SELF'];?>">
            <div class="form-group">
                <label>Write your password for confirmation</label>
                <input  name="password"type="password" name="" required="required" placeholder="your password" class="form-control">
            ...
            <button class="btn btn-primary btn-block  but1">Delete My Account</button>
...
$password=$_REQUEST['password'];
    ...
    $sql="DELETE FROM signup WHERE password=$password";
